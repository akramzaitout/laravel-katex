...
class BladeDirectivesTest extends TestCase
{
    ...
    {
        $output = Blade::render('@katexStyles');
    ...
    {
        $output = Blade::render('@katexScripts');
    ...
    {
        $output = Blade::render("@katexBlock('\\sum_{i=1}^{n}')");
    ...
    {
        $output = Blade::render("@katex('<script>alert(1)</script>')");
